...
def validate_config(config: Dict[str, Any]) -> None:
    ...
    # ATOM.cfg is mandatory whenever EMTO (KGRN) is expected to run.
    # That is, whenever we are NOT in pure prepare_only mode.
...
def apply_config_defaults(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    defaults = {
        ...
        # NOTE: slurm_account has no default to avoid hard-coding
        # cluster/project-specific information. It must be provided
        # explicitly in the YAML when run_mode='sbatch'.
        'slurm_account': None,
