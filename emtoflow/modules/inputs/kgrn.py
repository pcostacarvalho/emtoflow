...
def create_kgrn_input(structure, path, id_full, id_ratio, SWS, magnetic, nkx, nky, nkz, depth=1.100, efmix=0.900, tolcpa=1e-06, tolef=1e-08, efgs=0.000, hx=0.101, nx=5, amix=0.010, vmix=0.70, imagz=0.005, eps=0.200, nz0=16, strt='A', atom_file=None):
    """
