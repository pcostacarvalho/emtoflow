...
from emtoflow.modules.alloy_loop import format_composition_name, compute_global_percentages
...
def generate_percentage_configs(master_config_path: str,
    ...
    if master_config.get('create_master_job_script', False):
        ...
        if job_system == 'pelle':
            from emtoflow.modules.inputs.jobs_pelle import create_master_job_scripts
        else:  # default to tetralith
            from emtoflow.modules.inputs.jobs_tetralith import create_master_job_scripts
