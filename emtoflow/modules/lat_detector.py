...
from emtoflow.modules.element_database import DEFAULT_MOMENTS as DEFAULT_MAGNETIC_MOMENTS
from emtoflow.modules.element_database import DEFAULT_MOMENT_FALLBACK
from emtoflow.modules.element_database import get_default_moment as get_default_magnetic_moment
...
def parse_emto_structure(structure_input, user_magnetic_moments=None):
    ...
    if isinstance(structure_input, str):
        ...
        from emtoflow.modules.structure_builder import _structure_to_emto_dict
...
def validate_emto_vectors(cif_file, verbose=True):
    ...
    """
    from emtoflow.utils.parse_cif import get_LatticeVectors
