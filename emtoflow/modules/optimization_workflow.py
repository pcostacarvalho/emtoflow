...
from emtoflow.modules.inputs.eos_emto import create_eos_input, parse_eos_output
from emtoflow.utils.running_bash import run_sbatch, chmod_and_run
from emtoflow.utils.config_parser import load_and_validate_config, apply_config_defaults, CUBIC_LATTICES
...
class OptimizationWorkflow:
    ...
    def _validate_calculations(
        ...
        """
        from emtoflow.modules.optimization.execution import validate_calculations
    ...
    def optimize_ca_ratio(
        ...
        """
        from emtoflow.modules.optimization.phase_execution import optimize_ca_ratio
    ...
    def optimize_sws(
        ...
        """
        from emtoflow.modules.optimization.phase_execution import optimize_sws
    ...
    def run_optimized_calculation(
        ...
        """
        from emtoflow.modules.optimization.phase_execution import run_optimized_calculation
    ...
    def generate_dos_analysis(
        ...
        """
        from emtoflow.modules.optimization.analysis import generate_dos_analysis
    ...
    def generate_summary_report(self) -> str:
        ...
        """
        from emtoflow.modules.optimization.analysis import generate_summary_report
    ...
    def _run_prepare_only_mode(self) -> Dict[str, Any]:
        ...
        """
        from emtoflow.modules.optimization.prepare_only import run_prepare_only_mode
