...
from emtoflow.modules.extract_results import parse_kfcd, parse_kgrn
from emtoflow.modules.optimization.analysis import (
...
from emtoflow.modules.optimization.execution import _check_calculation_failed
...
def optimize_ca_ratio(
    ...
    if config.get('eos_auto_expand_range', False):
        ...
        if needs_expansion:
            ...
            from emtoflow.modules.optimization.analysis import save_parameter_energy_data
...
def run_calculations_for_parameter_values(
    ...
    if parameter_name == 'sws':
        ...
        # Create EMTO inputs (always create inputs, even in skip_calculations mode)
        phase_config = {
            **config,
